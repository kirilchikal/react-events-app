...
export default observer(function ActivityForm() {
    ...
    return (
        <Segment clearing>
            <Header content='Event details' sub color="purple" />
            <Formik 
                ...
                {({handleSubmit, isValid, isSubmitting}) => (
                    <Form className='ui form' onSubmit={handleSubmit} autoComplete='off'>
                        ...
                        <Button disabled={isSubmitting || !isValid} loading={isSubmitting} floated="right" positive type="submit" content="Submit"/>
